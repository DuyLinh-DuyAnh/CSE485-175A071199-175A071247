                ...
                <div class="card-body">
                    ...
                    <form method="POST" class="">
                        ...
                        <div class="row row-space">
                            <div class="col-12">
                                <div class="input-group">
                                    <button type="submit" name="bt_code" id="bt_code">Gửi mã xác nhận</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="">
                                <div class="input-group">
                                    <input class="input--style-4 w-auto " id="code" type="text" name="code" value="" placeholder="Nhập mã xác nhận">
                                </div>
                            </div>
                        </div>
                        <div class="p-t-15 ">
